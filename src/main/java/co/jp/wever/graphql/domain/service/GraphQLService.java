...
public class GraphQLService {
    ...
    private RuntimeWiring buildRuntimeWiring() {
        return RuntimeWiring.newRuntimeWiring()
            .type("Query", typeWiring -> typeWiring.dataFetcher("section", sectionDataFetcher.sectionDataFetcher())
            ...
            .type("Mutation", typeWiring -> typeWiring.dataFetcher("addSection", sectionDataFetcher.addSectionDataFetcher())
