...
public class PlanElementConverter {
    public static PlanElement toPlanElement(PlanElementInput planElementInput) {
        return new PlanElement(PlanElementId.of(planElementInput.getTargetId()), PlanElementTitle.of(planElementInput.getTitle()),PlanElementNumber.of(planElementInput.getNumber()), PlanElementType.valueOf(planElementInput.getType()));
    }
}
