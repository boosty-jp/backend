...
import co.jp.wever.graphql.domain.repository.course.UpdatePlanRepository;
...
public class UpdatePlanRepositoryImpl implements UpdatePlanRepository {
    ...
    public void publishOne(PublishPlan publishPlan, String userId) {
        ...
        algoliaClient.getCourseIndex()
                     .saveObjectAsync(CourseSearchEntityConverter.toPlanSearchEntity(publishPlan, userId, now));
    }
    ...
    public void draftOne(DraftPlan draftPlan, String userId) {
        ...
        algoliaClient.getCourseIndex().deleteObjectAsync(draftPlan.getId());
    }
    ...
    public void likeOne(String planId, String userId) {
        ...
        algoliaClient.getCourseIndex()
                     .partialUpdateObjectAsync(CourseSearchEntity.builder().objectID(planId).like(liked).build());
    }
    ...
    public void startOne(String planId, String userId) {
        ...
        algoliaClient.getCourseIndex()
                     .partialUpdateObjectAsync(CourseSearchEntity.builder().objectID(planId).learning(learning).build());
    }
    ...
    public void finishOne(String planId, String userId, List<String> elementIds) {
        ...
        g.V(planId)
         ...
         .next();
        algoliaClient.getCourseIndex()
                     .partialUpdateObjectAsync(CourseSearchEntity.builder()
                                                                 .objectID(planId)
                                                                 .learning(learning)
                                                                 .learned(learned)
                                                                 .build());
