...
public class CourseEntityConverter {
    ...
    public static CourseEntity toCourseEntityForList(Map<String, Object> findResult) {
        ...
        return CourseEntity.builder()
                           .base(CourseBaseEntityConverter.toCourseBaseEntity(baseResult,
    ...
    public static CourseEntity toCourseEntityForListWithStatus(Map<String, Object> findResult) {
        Map<Object, Object> baseResult = (Map<Object, Object>) findResult.get("base");
        List<Map<Object, Object>> tagResult = (List<Map<Object, Object>>) findResult.get("tags");
        ...
        return CourseEntity.builder()
                           .base(CourseBaseEntityConverter.toCourseBaseEntity(baseResult, status))
                           .tags(tagResult.stream()
                                          .map(t -> TagEntityConverter.toTagEntity(t))
                                          .collect(Collectors.toList()))
                           .actionCounts(ActionCountEntity.builder().likeCount(like).learnedCount(learned).build())
