...
import jp.boosty.graphql.infrastructure.constant.vertex.property.SectionVertexProperty;
...
import jp.boosty.graphql.domain.repository.book.BookMutationRepository;
...
import jp.boosty.graphql.infrastructure.constant.edge.property.PurchaseEdgeProperty;
...
import jp.boosty.graphql.infrastructure.util.EdgeIdCreator;
...
public class BookMutationRepositoryImpl implements BookMutationRepository {
    ...
    public String create(String userId) {
        ...
        String bookId = g.addV(VertexLabel.BOOK.getString())
    ...
    public String createPage(String sectionId, long sectionCount, String userId) {
        ...
        String pageId = g.addV(VertexLabel.PAGE.getString())
