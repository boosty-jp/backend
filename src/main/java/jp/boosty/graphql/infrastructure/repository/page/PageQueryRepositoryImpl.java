package jp.boosty.graphql.infrastructure.repository.page;
...
import jp.boosty.graphql.infrastructure.converter.entity.page.LikedPageEntityConverter;
...
import jp.boosty.graphql.domain.repository.page.PageQueryRepository;
...
import jp.boosty.graphql.infrastructure.converter.entity.page.PageEntityConverter;
...
public class PageQueryRepositoryImpl implements PageQueryRepository {
    ...
    public PageEntity findOne(String bookId, String pageId, String userId) {
        ...
        Map<String, Object> result = g.V(pageId)
