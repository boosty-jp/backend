...
import jp.boosty.backend.application.converter.book.BookBaseInputConverter;
import jp.boosty.backend.application.converter.book.BookResponseConverter;
import jp.boosty.backend.application.converter.book.BookTargetsInputConverter;
...
import jp.boosty.backend.application.datamodel.response.query.book.BookListResponse;
import jp.boosty.backend.domain.service.book.BookMutationService;
import jp.boosty.backend.domain.service.book.BookQueryService;
